...
from database.db_manager import get_all_users, delete_user, get_pending_password_resets_count
...
class UserManagementTab(ttk.Frame):
    ...
    def create_widgets(self):
        # HIER DIE KORREKTUR: main_frame wird nicht mehr benötigt
        self.pack(expand=True, fill="both", padx=10, pady=10) # Direkt auf dem Tab-Frame packen
